...
class ReqResResult: BaseResult, TestResult {
    ...
    // MARK: Initializers
    init(name: String, proto: NetProtocol, success: Bool, result: String, duration: Double, startTime: Date, waitTime: Double, wifiBytesReceived: UInt32, wifiBytesSent: UInt32, cellBytesReceived: UInt32, cellBytesSent: UInt32, missed: Int64, maxDelay: Int64, delays: [Int64]) {
        self.missed = missed
